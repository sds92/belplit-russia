    ...
    <div className={`py-10`}>
      ...
      <div className={`flex flex-col w-full`}>
        <div className={`w-full flex flex-col items-center sm:flex-row sm:gap-2 md:gap-10 my-2 `}>
          ...
          {/* CONTACTS */}
          <div
            className={`flex w-full flex-wrap sm:max-w-xl sm:flex-col sm:w-1/3 md:w-5/12 p-2 mr-auto`}
          >
            <div className={`sm:w-full w-1/2 my-1 flex flex-col`}>
              <div className={`flex h-6 mx-0.5`}>
                <Icons.Phone extraClasses={`pl-1 w-6 h-6 border-b border-belplit text-belplit`} />
            ...
            <div className={`w-1/2 sm:w-full my-1 flex flex-col`}>
              <div className={`flex h-6 mx-0.5`}>
                <Icons.Mail extraClasses={`pl-1 text-center w-6 h-6 border-b border-belplit text-belplit`} />
            ...
            <div className={`w-1/2 sm:w-full my-1 flex flex-col`}>
              <div className={`flex h-6 mx-0.5`}>
                <Icons.Location
                  extraClasses={`pl-1 w-6 h-6 pt-0.5 border-b border-belplit text-belplit`}
                />
            ...
            <div className={`w-1/2 sm:w-full my-1 flex flex-col`}>
              <div className={`flex h-6 mx-0.5`}>
                <Icons.Clock extraClasses={`pl-0.5 w-6 h-6 border-b border-belplit text-belplit`} />
